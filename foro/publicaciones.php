                        ...
                        <div class="carousel-inner">
                            ...
                            echo '<div class="foro">';
                                ...
                                while ($registro = mysqli_fetch_assoc($consulta)) {
                                    ...
                                    ?>
                                        <div id="publi<?php echo $IDPublicacion ?>" class="publicacionesForo1" onmousedown="dragStart(event, 'publi<?php echo $IDPublicacion ?>')" onmouseup="dragEnd(event, 'publi<?php echo $IDPublicacion ?>')">
                                    ...
                                    echo '<div class="btn_publicar"> <a href="publicacion.html"> Redactar </a></div>';
                                echo '</div>';
                            echo '</div>';
                            ?>
                            </div>
                                    ...
                                    <a>Rutinas</a>
                                        ...
                                        echo '<div class="foro">';
                                            ...
                                            while ($registro = mysqli_fetch_assoc($consulta)) {
                                                ...
                                                echo '<div class="btn_publicar">';
                                                echo '<a href="publicacion_3.html"> Redactar </a>';
                                            echo '</div>';
                                            echo '</div>';
                                        echo '</div>';
                                        ?>
